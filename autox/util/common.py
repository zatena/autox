...
class MyRegression:
    ...
    def execute_case(self, scenario_list, excReport):
        ...
        for i in range(len(scenario_list)):
            ...
            try:
                for i in range(0, all_result):
                        ...
                        if actual_response is not None:
                            ...
                            if actual_status_code is not None:
                                ...
                                if assert_len > 1:
                                    ...
                                    summary_report = excReport.sum_result(scenario_name, url, method, name, run_time,
                    ...
                    if len(url) > 120:
                        url = url[0:110]
                    summary_report = excReport.sum_result(scenario_name, url, method, name, run_time, test_status,
    ...
    def build_report(self, scenario_list, excReport):
        try:
            test_report = self.execute_case(scenario_list, excReport)
            return excReport.build_report(test_report.sum_report, test_report.name, test_report.all_test,
